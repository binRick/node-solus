        ...
        callback: function(err, res) {
            ...
            s(reqJson, function(e, Setup) {
                ...
                p(Solus, Setup, reqJson, function(e, res) {
                    if (e) throw e;
                    var v2 = plugin.Events.unsuspendVM.validate;
                    var s2 = plugin.Events.unsuspendVM.setup;
                    var p2 = plugin.Events.unsuspendVM.process;
                    api_calls = {};
                    api_calls['client.service_get'] = {
                        ...
                        callback: function(err, res) {
                            ...
                            var V2 = v2(reqJson);
                            if (!V2) {
                                var msg = 'Failed to unsuspend vm';
                                console.log(msg);
                                return CB(msg, null);
                            } else {
...
CB(err, 'VM Unsuspended in Solus ');
