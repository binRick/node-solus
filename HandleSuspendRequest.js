        ...
        callback: function(err, res) {
            ...
            s(reqJson, function(e, Setup) {
                ...
                p(Solus, Setup, reqJson, function(e, res) {
                    if (e) throw e;
                    var v2 = plugin.Events.suspendVM.validate;
                    var s2 = plugin.Events.suspendVM.setup;
                    var p2 = plugin.Events.suspendVM.process;
                    api_calls = {};
